...
def consult_food_handle(current_slot, customer_utterance, state_tracker_obj, entities, lac, intent_model, db_obj, collection_name):
    ...
    if last_slot_state is not "confirm":
        ...
        confirm_state, temp_entities = food_nlu.confirm_search_food(customer_utterance, lac, intent_model)
