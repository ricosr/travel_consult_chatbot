...
def dinning_handle(current_slot, customer_utterance, state_tracker_dict, just_sentence, if_case_no, db_obj):
    ie_values_dict, yes_no = dinning_nlu_rule(customer_utterance)
    if yes_no == "positive" and if_case_no == 4:    # TODO: 0405, the same way to 0,1,2,3
    ...
    if yes_no == 'negative' and if_case_no == 4:
